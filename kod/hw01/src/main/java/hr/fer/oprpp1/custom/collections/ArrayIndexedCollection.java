...
/**
 * Razred predstavlja kolekciju u kojoj su dopušteni duplikati elemenata, ali pohrana null refernci nije dopuštena.
 * 
 * @author Maria
 *
 */
public class ArrayIndexedCollection extends Collection {
	...
	public void add(Object value) {
		...
		if (size == elements.length) {
			Object[] helpArray = new Object[elements.length];
			for (int i = 0; i < elements.length; i++) {
				helpArray[i] = elements[i];
			}
			elements = new Object[helpArray.length * 2];
